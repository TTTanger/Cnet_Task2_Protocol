...
class server:
    ...
    def send(self, message, client):
        ...
        if len(message) > Frame.FRAGMENT_SIZE * 2:
            return self.send_fragmented_message(message, client)
        else:
            return self.send_small_message(message, client)
        
    def send_fragmented_message(self, message, client):
    ...
    def send_small_message(self, message, client):
        """Send small message"""
        retries = 0
    ...
    def send_thread(self):
        ...
        while True:
            ...
            if message == b'test_large':
                ...
                self.send(large_message, client)
            else:
